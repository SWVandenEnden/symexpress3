...
testData = [ # 1
           ...
           , # 44
            ...
            , # 75
             ...
             , 'result'     : '36^^(1/3) * (a^^-1 * pi * e)^^(4/9)'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 76, special for mpmath (1.3.0), with precision set to 150 it give by calculcaton the wrong answer (7.6373...), 4 may 2026
             { 'expression' : '(-1) * 3^^(1/2) + 1 * 2^^-1 * 3^^(1/2) + 1 * 2^^-1 * (3 * 3^^(1/2))^^(1/3)'
             , 'result'     : '0'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 77
             { 'expression' : 'exp( (-1) * 2^^-1,((198185615 * 3456^^-1 + 4434869 * 3456^^-1 * 1997^^(1/2))^^-1 * 104021936927 * 2985984^^-1)^^-1 )'
             , 'result'     : 'exp( (-1/2),(171232371360/104021936927) + (3831726816/104021936927) * 1997^^(1/2) )'
             , 'actions'    : [ 'optimizeNormal' ]
             }
            , # 78
             { 'expression' : 'exp( (-1) * 2^^-1,(198185615 * 3456^^-1 + 1997^^(1/2) * (-4434869) * 3456^^-1)^^-1 ) * exp( (-1) * 1 * 60^^-1,(198185615 * 3456^^-1 + (-4434869) * 3456^^-1 * 1997^^(1/2))^^-1 )'
             , 'result'     : '((198185615/3456) + 1997^^(1/2) * (-4434869/3456))^^(31/60)'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 79
             { 'expression' : '5^^(1/2) * i * (2/5) + cos( atan( 4 * 5^^(1/2) ) * (1/2) ) * 5^^(1/2) * (-3/5) + i * sin( atan( 4 * 5^^(1/2) ) * (1/2) ) * 5^^(1/2) * (-3/5)'
             , 'result'     : '-1'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 80
             { 'expression' : '((771 * (140550750303 * 5^^-1 + (-778779390  ) * ( 25 * 257 * 5^^-1 )^^(1/2))^^(1/2))^^3)'
             , 'result'     : '458314011 * ((140550750303/5) + (-778779390) * 1285^^(1/2))^^(3/2)'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 81
             { 'expression' : '(((140550750303 * 5^^-1 + (-778779390) * 1285^^(1/2))^^(1/2) * 49344 * 4657463^^-1 + 3423980160 * 4657463^^-1 + 1285^^(1/2) * (-703711232) * 23287315^^-1))^^(-1/3)'
             , 'result'     : '(167/4) * (771 * ((140550750303/5) + (-778779390) * 1285^^(1/2))^^(1/2) + 53499690 + (-10995488/5) * 1285^^(1/2))^^(-1/3)'
             , 'actions'    : [ 'optimizeExtended' ]
             }
