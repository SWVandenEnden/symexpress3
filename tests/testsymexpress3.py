...
testData = [ # 1
           ...
           , # 27 symArray
             ...
             # { 'expression' : '1'
             { 'expression' : '(-16)^(1/2) + (-27)^(1/3) + (-16)^(1/4)'
             ...
             # , 'result'       : '1'
             , 'result'       : '[ 4 * i + (3/2) + (3/2) * i * 3^^(1/2) + 2^^(1/2) + (-1) * i * 2^^(1/2) | 4 * i + (3/2) + (3/2) * i * 3^^(1/2) + i * 2^^(1/2) + 2^^(1/2) | 4 * i + (3/2) + (3/2) * i * 3^^(1/2) + (-1) * 2^^(1/2) + i * 2^^(1/2) | 4 * i + (3/2) + (3/2) * i * 3^^(1/2) + (-1) * i * 2^^(1/2) + (-1) * 2^^(1/2) | 4 * i + (-3) + 2^^(1/2) + (-1) * i * 2^^(1/2) | 4 * i + (-3) + i * 2^^(1/2) + 2^^(1/2) | 4 * i + (-3) + (-1) * 2^^(1/2) + i * 2^^(1/2) | 4 * i + (-3) + (-1) * i * 2^^(1/2) + (-1) * 2^^(1/2) | 4 * i + (3/2) + i * 3^^(1/2) * (-3/2) + 2^^(1/2) + (-1) * i * 2^^(1/2) | 4 * i + (3/2) + i * 3^^(1/2) * (-3/2) + i * 2^^(1/2) + 2^^(1/2) | 4 * i + (3/2) + i * 3^^(1/2) * (-3/2) + (-1) * 2^^(1/2) + i * 2^^(1/2) | 4 * i + (3/2) + i * 3^^(1/2) * (-3/2) + (-1) * i * 2^^(1/2) + (-1) * 2^^(1/2) | (-4) * i + (3/2) + (3/2) * i * 3^^(1/2) + 2^^(1/2) + (-1) * i * 2^^(1/2) | (-4) * i + (3/2) + (3/2) * i * 3^^(1/2) + i * 2^^(1/2) + 2^^(1/2) | (-4) * i + (3/2) + (3/2) * i * 3^^(1/2) + (-1) * 2^^(1/2) + i * 2^^(1/2) | (-4) * i + (3/2) + (3/2) * i * 3^^(1/2) + (-1) * i * 2^^(1/2) + (-1) * 2^^(1/2) | (-4) * i + (-3) + 2^^(1/2) + (-1) * i * 2^^(1/2) | (-4) * i + (-3) + i * 2^^(1/2) + 2^^(1/2) | (-4) * i + (-3) + (-1) * 2^^(1/2) + i * 2^^(1/2) | (-4) * i + (-3) + (-1) * i * 2^^(1/2) + (-1) * 2^^(1/2) | (-4) * i + (3/2) + i * 3^^(1/2) * (-3/2) + 2^^(1/2) + (-1) * i * 2^^(1/2) | (-4) * i + (3/2) + i * 3^^(1/2) * (-3/2) + i * 2^^(1/2) + 2^^(1/2) | (-4) * i + (3/2) + i * 3^^(1/2) * (-3/2) + (-1) * 2^^(1/2) + i * 2^^(1/2) | (-4) * i + (3/2) + i * 3^^(1/2) * (-3/2) + (-1) * i * 2^^(1/2) + (-1) * 2^^(1/2) ]'
             , 'actions'    : [ 'optimizeExtended' ]
             }
           , # 28
           ...
           , # 44
            ...
            , # 82 -> OptimizeDivideDivide
             { 'expression' : '(-3) * ((-1) * 2^^-1 + 1 * 2^^-1 * i * 3^^(1/2))^^-1 * ((1 * 2^^-1 * 2917^^(1/2) + 55 * 2^^-1)^^-1 * (-27))^^(-1/3)'
             , 'result'     : '((55/2) + (1/2) * 2917^^(1/2))^^(1/3)'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 83 -> OptimizeSplitDenominator
             { 'expression' : '(1/2) * ((1/2) * 2917^^(1/2) + (-55/2))^^(1/3) + (-1/2) * i * 3^^(1/2) * ((1/2) * 2917^^(1/2) + (-55/2))^^(1/3) + (-3) * ((-1/2) + (1/2) * i * 3^^(1/2))^^-1 * ((1/2) * 2917^^(1/2) + (-55/2))^^(-1/3)'
             , 'result'     : '((55/2) + (-1/2) * 2917^^(1/2))^^(1/3) + ((55/2) + (1/2) * 2917^^(1/2))^^(1/3)'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 84 -> 1/1/(imaginair root)
             { 'expression' : '5 * ((-3) * ((1/2) * -2917^^(1/2) + (55/2))^^-1)^^(-1/3) '
             , 'result'     : '(-5/12) * 95072^^(1/6) * 9^^(1/3) * i * cos( (1/3) * atan( 2917^^(1/2) * (55/2917) ) ) + (-5/4) * i * sin( (1/3) * atan( 2917^^(1/2) * (55/2917) ) ) * 285216^^(1/6) + (5/4) * cos( (1/3) * atan( 2917^^(1/2) * (55/2917) ) ) * 285216^^(1/6) + (-5/12) * 95072^^(1/6) * 9^^(1/3) * sin( (1/3) * atan( 2917^^(1/2) * (55/2917) ) )'
             , 'actions'    : [ 'optimizeExtended' ]
             }
            , # 85 -> log()
            ...
            , # 86 -> compactDenominator
             { 'expression' : '(126814080/4657463) + 1285^^(1/2) * (-703711232/628757505) + (((140550750303/5) + (-778779390) * 1285^^(1/2))^^(1/2) * (49344/4657463) + (3423980160/4657463) + 1285^^(1/2) * (-703711232/23287315))^^-1 * (31266037781579460608/585682963101963) + (((140550750303/5) + (-778779390) * 1285^^(1/2))^^(1/2) * (49344/4657463) + (3423980160/4657463) + 1285^^(1/2) * (-703711232/23287315))^^-1 * 1285^^(1/2) * (-34533272782544896/21691961596369) + ((140550750303/5) + (-778779390) * 1285^^(1/2))^^(1/2) * (-16448/41917167)'
             , 'result'     : '0'
             , 'actions'    : [ 'optimizeExtended' ]
             }
